    ...
    def get_content_base(self, for_readme):
        return "\n".join([
            ...
            utils.get_bootstrap_alert(
                ...
                content=md("\n".join([
                    "- **%s**: %s" % (_("Acromatopia (rod monochromatism)"),
                                      _("Total or almost total color blindness.")),
                    "- **%s**: %s" % (_("Acromatopia (blue-cone monochromatism)"),
                                      _("Total or almost total color blindness.")),
                    "- **%s**: %s" % (_("Deuteranopia"), _("Green color deficiency.")),
                    "- **%s**: %s" % (_("Protanopia"), _("Red color deficiency.")),
                    "- **%s**: %s" % (_("Tritanopia"), _("Blue color deficiency.")),
                ])
                )),
            "",
            "## %s" % _("Features"),
