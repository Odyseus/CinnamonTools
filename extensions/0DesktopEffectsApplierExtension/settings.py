...
CONTRAST_INFO_LABELS = [
    "<b>%s:</b> %s" % (cgi.escape(_("Color levels")),
                       cgi.escape(_("Color component of the change in contrast where 0.0 designates no change.")))
]

BRIGHTNESS_INFO_LABELS = [
    "<b>%s:</b> %s" % (cgi.escape(_("Color levels")),
                       cgi.escape(_("Color component of the change in brightness where 0.0 designates no change.")))
]
...
if __name__ == "__main__":
    ...
    app = MainApplication(
        application_base_id="org.Cinnamon.Extensions.DesktopEffectsApplier.Settings",
