...
var EXTENSION_PREFS = [
    ...
    "default_translator",
    "translators_prefs",
    "translators_prefs_defaults_control",
    "translators_prefs_defaults",
    "translators_prefs_defaults_apply",
    "trigger_date_format_syntax_info",
    "languages_stats",
    "last_translator",
    "remember_last_translator",
    "auto_translate_when_switching_language",
    "show_most_used",
    ...
    "history_enabled",
    "history_timestamp",
    "history_timestamp_custom",
    "history_width_to_trigger_word_wrap",
    "yandex_api_keys",
    "loggin_save_history_indented",
    "keep_source_entry_text_selected",
    "informed_about_dependencies"
];
...
// NOTE: Keep in sync with translators_prefs_defaults_control.
...
// NOTE: Keep in sync with translators_prefs_defaults.
// Add/remove engines.
...
var StatusBarMessageParams = Object.freeze({
    message: "",
...
var DialogPopupItemParams = Object.freeze({
    label: "",
    icon_name: "",
    callback: null,
    is_translators_popup: false
});
var SpinnerParams = Object.freeze({
    speed: 200,
    sequence: ["—", "\\", "|", "/", "—"]
});
 ...
 */
var TranslationProviderParams = Object.freeze({
    name: "",
    char_limit: 1400,
    max_queries: 3,
    url: "",
