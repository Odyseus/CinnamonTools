    ...
    "sections": [{
        ...
        "widgets": [{
            ...
            "args": {
                ...
                "tooltip": _("Keep source entry text selected whenever the translation \
dialog is opened and the source entry box contains text.")
            }
        }, {
            "type": "switch",
            "args": {
...
changing this setting, only new entries in the translation history will be saved with the new \
timestamp format. Old entries will still have the previous timestamp format."),
                "values": {
                    "custom": _("Custom"),
...
\nYYYY: year\nMM: month\nDD: day\nhh: hours\nmm: minutes\nss: seconds")
            ...
            "args": {
                ...
                "tooltip": _("The \"Source text\" and \"Target text\" columns on the history \
window will wrap its text at the width defined by this setting."),
                "min": 100,
                "max": 1024,
                "step": 10,
                "units": _("pixels")
    ...
    "sections": [{
        ...
        "widgets": [{
            ...
            "args": {
                    ...
                    "tooltip": _("Enter one API key per line.\nRead the help file found inside \
this extension folder to know how to get free Yandex API keys.")
            }
        }, {
            "type": "info_label",
            "args": {
            ...
            "args": {
                ...
                "tooltip": _("It enables the ability to log the output of several functions used \
by the extension.")
            }
        }, {
            "type": "switch",
                ...
                for i in range(0, len(SECTION_WIDGETS)):
                    ...
                    try:
                        ...
                        if Settings().settings_has_key(dep_key):
                            ...
                            print("Ignoring dependency on key '%s': no such key in the schema" %
                                  dep_key)
...
def remove_schema():
    ...
    if os.path.exists("/usr/bin/gksu") and os.path.exists("/usr/share/cinnamon/cinnamon-settings/bin/removeSchema.py"):
        ...
        ui_error_message(
            # TO TRANSLATORS: Could be left blank.
            msg=_("Could not remove the settings schema for %s. You will have to perform this step \
yourself.  This is not a critical error.") % (EXTENSION_UUID))
