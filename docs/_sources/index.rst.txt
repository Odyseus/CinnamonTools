...
.. toctree::
    ...
    includes/cinnamontools-requirements
    includes/cinnamontools-usage
    includes/cinnamontools-dev-notes
    includes/cinnamontools-code-styling
    includes/cinnamontools-help-pages
