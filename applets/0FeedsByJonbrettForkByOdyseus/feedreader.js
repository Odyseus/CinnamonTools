...
FeedReader.prototype = {
    ...
    _init: function(logger, url, path, callbacks) {
        ...
        let script_path = Gio.file_parse_name(this.path + "/" + sanitize_url(this.url)).get_path();
    ...
    save_items: function() {
        ...
        try {
            let dir = Gio.file_parse_name(this.path);
             ...
             * later */
            let filename = this.path + "/" + sanitize_url(this.url);
