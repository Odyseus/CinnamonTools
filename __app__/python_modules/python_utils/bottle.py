...
try:
    ...
    def _stdout(x): return sys.stdout.write(x)

    def _stderr(x): return sys.stderr.write(x)
...
class ConfigDict(dict):
    ...
    __slots__ = ('_meta', '_change_listener', '_overlays',
                 '_virtual_keys', '_source', '__weakref__')
...
class AiohttpServer(AsyncioServerAdapter):
    ...
    def run(self, handler):
        ...
        def protocol_factory(): return WSGIServerHttpProtocol(
            handler,
            readpayload=True,
