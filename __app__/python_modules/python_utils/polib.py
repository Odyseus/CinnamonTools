...
#
# README:
# See "FIXME 1" and "FIXME 2".
# Since I use the polib library in situations where it is not possible to find
# plural strings, I really don't care if that part of this module code is broken.
# The original author tried to fix the situation, but I don't see how what he
# did fixes anything.
# MOVING ON...
...
class POEntry(_BaseEntry):
    ...
    def __cmp__(self, other):
        ...
        if msgctxt > othermsgctxt:
            ...
            return -1
        # FIXME 1:
        # I honestly have no idea what the original author wants to achieve here.
        # It tries to compare if a string is greater/less than another
        # string. Or that's what I gather, because msgid_plural is supposed
        # to be a string.
